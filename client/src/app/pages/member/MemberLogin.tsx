...
const hasDemoCreds =
  !!import.meta.env.VITE_MEMBER_DEMO_EMAIL &&
  import.meta.env.VITE_MEMBER_DEMO_EMAIL !== "";
...
export default function MemberLogin() {
  ...
  const handleDemoCredentials = () => {
    setEmail(import.meta.env.VITE_MEMBER_DEMO_EMAIL as string);
    setPassword(import.meta.env.VITE_MEMBER_DEMO_PASSWORD as string);
  };
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-8">
        ...
        <div className="bg-white border border-[#f3f4f6] rounded-[20px] p-8 w-full max-w-[420px] shadow-sm">
          ...
          <p className="font-['Albert_Sans',sans-serif] text-[14px] leading-[20px] text-[#6a7282] mb-6">
            Access the Coop-op Member Portal
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 border border-[#e5e7eb] rounded-[10px] font-['Albert_Sans',sans-serif] text-[14px] focus:outline-none focus:border-[#7F56D9] pr-12 transition-colors"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            {hasDemoCreds && (
              <div className="bg-[#faf5ff] border border-[#e9d7fe] rounded-[10px] p-4">
                <p className="font-['Albert_Sans',sans-serif] font-semibold text-[12px] text-[#7F56D9] mb-2">
                  Demo Credentials
                </p>
                <p className="font-['Albert_Sans',sans-serif] text-[11px] text-[#6a7282] mb-1">
                  <span className="font-mono">
                    Email: {import.meta.env.VITE_MEMBER_DEMO_EMAIL}
                  </span>
                </p>
                <p className="font-['Albert_Sans',sans-serif] text-[11px] text-[#6a7282] mb-3">
                  <span className="font-mono">
                    Password: {import.meta.env.VITE_MEMBER_DEMO_PASSWORD}
                  </span>
                </p>
                <button
                  type="button"
                  onClick={handleDemoCredentials}
                  className="w-full bg-white border border-[#e9d7fe] text-[#7F56D9] font-['Albert_Sans',sans-serif] font-semibold text-[13px] py-2 rounded-[8px] hover:bg-[#faf5ff] transition-colors cursor-pointer"
                >
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-[#7F56D9] to-[#6941c6] text-white font-['Albert_Sans',sans-serif] font-semibold text-[14px] py-3 rounded-[10px] hover:opacity-90 transition-opacity mt-2 disabled:opacity-60 cursor-pointer"
            >
              {loginMutation.isPending ? "Logging in..." : "Login to Member Portal"}
            </button>
        ...
        <p className="font-['Albert_Sans',sans-serif] text-[12px] text-[#99a1af] text-center mt-6 max-w-[320px]">
          Access is by invitation only. Contact your cooperative manager.
        </p>
      </div>
