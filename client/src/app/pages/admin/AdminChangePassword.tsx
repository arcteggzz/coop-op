...
import { useAdminRequestOtp, useAdminChangePassword } from "../../hooks/useAdminAuth";
                ...
                {i < 2 && (
                  <div
                    className={`flex-1 h-[2px] rounded-full ${
                      stepNumber > n ? "bg-[#dc2626]" : "bg-[#f3f4f6]"
                    }`}
                  />
                )}
              </>
            ...
            <>
              ...
              <form onSubmit={handleSendOtp} className="space-y-5">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-[#dc2626] to-[#b91c1c] text-white font-['Albert_Sans',sans-serif] font-semibold text-[14px] py-3 rounded-[10px] hover:opacity-90 transition-opacity disabled:opacity-60 cursor-pointer"
                >
              ...
              <form onSubmit={handleVerifyOtp} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    maxLength={6}
                    className="w-full px-4 py-3 border border-[#e5e7eb] rounded-[10px] font-['Albert_Sans',sans-serif] text-[14px] focus:outline-none focus:border-[#dc2626] transition-colors tracking-[0.3em] text-center text-[18px]"
                    placeholder="123456"
                  />
                </div>
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-[#dc2626] to-[#b91c1c] text-white font-['Albert_Sans',sans-serif] font-semibold text-[14px] py-3 rounded-[10px] hover:opacity-90 transition-opacity cursor-pointer"
                >
                  Continue
                </button>
                <button
