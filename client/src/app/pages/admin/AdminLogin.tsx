...
const hasDemoCreds =
  !!import.meta.env.VITE_ADMIN_DEMO_EMAIL &&
  import.meta.env.VITE_ADMIN_DEMO_EMAIL !== "";
...
export default function AdminLogin() {
  ...
  const handleDemoCredentials = () => {
    setEmail(import.meta.env.VITE_ADMIN_DEMO_EMAIL as string);
    setPassword(import.meta.env.VITE_ADMIN_DEMO_PASSWORD as string);
  };
  ...
  return (
    <div className="bg-[#fafbfd] min-h-screen flex flex-col">
      <div className="bg-gradient-to-r from-[#dc2626] via-[#b91c1c] to-[#ef4444] h-[4px] w-full" />
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-8">
        ...
        <div className="bg-white border border-[#f3f4f6] rounded-[20px] p-8 w-full max-w-[420px] shadow-sm">
          ...
          <p className="font-['Albert_Sans',sans-serif] text-[14px] leading-[20px] text-[#6a7282] mb-6">
            Access the Coop-op Admin Dashboard
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-[#e5e7eb] rounded-[10px] font-['Albert_Sans',sans-serif] text-[14px] focus:outline-none focus:border-[#dc2626] transition-colors"
                placeholder="admin@coop-op.com"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 border border-[#e5e7eb] rounded-[10px] font-['Albert_Sans',sans-serif] text-[14px] focus:outline-none focus:border-[#dc2626] pr-12 transition-colors"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            {hasDemoCreds && (
              <div className="bg-[#fff5f5] border border-[#fecaca] rounded-[10px] p-4">
                <p className="font-['Albert_Sans',sans-serif] font-semibold text-[12px] text-[#dc2626] mb-2">
                  Demo Credentials
                </p>
                ...
                <button
                  ...
                  className="w-full bg-white border border-[#fecaca] text-[#dc2626] font-['Albert_Sans',sans-serif] font-semibold text-[13px] py-2 rounded-[8px] hover:bg-[#fff5f5] transition-colors cursor-pointer"
                >
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-[#dc2626] to-[#b91c1c] text-white font-['Albert_Sans',sans-serif] font-semibold text-[14px] py-3 rounded-[10px] hover:opacity-90 transition-opacity mt-2 disabled:opacity-60 cursor-pointer"
            >
        ...
        <p className="font-['Albert_Sans',sans-serif] text-[12px] text-[#99a1af] text-center mt-6 max-w-[320px]">
          Access is by invitation only. Contact your system administrator.
        </p>
      </div>
