...
export default function ManagerChangePassword() {
  ...
  const requestOtpMutation = useManagerRequestOtp();
  const changePasswordMutation = useManagerChangePassword();
                ...
                {i < 2 && (
                  <div
                    className={`flex-1 h-[2px] rounded-full ${
                      stepNumber > n ? "bg-[#0D8FAF]" : "bg-[#f3f4f6]"
                    }`}
                  />
                )}
              </>
          ...
          {step === "email" && (
            <>
              ...
              <p className="font-['Albert_Sans',sans-serif] text-[14px] leading-[20px] text-[#6a7282] mb-6">
                Enter your manager email to receive a one-time passcode.
              </p>
              <form onSubmit={handleSendOtp} className="space-y-5">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-[#0D8FAF] to-[#066E86] text-white font-['Albert_Sans',sans-serif] font-semibold text-[14px] py-3 rounded-[10px] hover:opacity-90 transition-opacity disabled:opacity-60 cursor-pointer"
                >
              ...
              <form onSubmit={handleVerifyOtp} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    maxLength={6}
                    className="w-full px-4 py-3 border border-[#e5e7eb] rounded-[10px] font-['Albert_Sans',sans-serif] text-[14px] focus:outline-none focus:border-[#0D8FAF] transition-colors tracking-[0.3em] text-center"
                    placeholder="123456"
                  />
                </div>
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-[#0D8FAF] to-[#066E86] text-white font-['Albert_Sans',sans-serif] font-semibold text-[14px] py-3 rounded-[10px] hover:opacity-90 transition-opacity cursor-pointer"
                >
                  Continue
                </button>
                <button
