...
import * as managerMgmtApi from "../../api/managerManagement.api";
import type {
  DuePayment,
  IssueDuesDto,
  RecordPaymentDto,
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 p-8 font-['Albert_Sans',sans-serif]">
        ...
        <p className="text-[13px] text-[#6b7280] mb-6">
          Creates a payment record for every active member.
        </p>
...
export default function ManagerDueScheduleDetail() {
  ...
  // View 1: all payments for cycles table + cycle drill-down (fetch large batch)
  ...
  const { data: membersData } = useQuery({
    queryKey: ["manager-members-all", cooperativeId],
    queryFn: () => managerMgmtApi.getMembers(cooperativeId, { pageSize: 500 }),
  ...
  // Summary card values — member-scoped when view=member-details and a member is selected
                  ...
                  <tbody>
                    {paymentsLoading ? (
                      ...
                      <tr>
                        ...
                        >
                          No periods issued yet.{" "}
                          {canWrite
                            ? 'Click "Issue Period" to get started.'
                            : ""}
                        </td>
                      </tr>
                    ) : (
                                ...
                                (p.status === "Pending" ||
                                  ...
                                  <div className="flex items-center gap-2">
                                    <button
                                      ...
                                      className="text-[12px] font-medium text-[#0D8FAF] hover:underline cursor-pointer whitespace-nowrap"
                                    >
                                      Mark Paid
                                    </button>
                                    <button
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mb-4">
                <select
                  ...
                  className="border border-[#e5e7eb] rounded-[8px] cursor-pointer px-3 py-2 text-[13px] text-[#374151] font-['Albert_Sans',sans-serif] focus:outline-none focus:border-[#0D8FAF] bg-white"
                >
